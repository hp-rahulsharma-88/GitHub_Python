class Dog:
    ...
    def __init__(self, name, age):
        # Instance variables -
        # Variables that are unique to each instance (object) of a class. These are defined within
        # the __init__ method or other instance methods. Each object maintains its own copy of instance variables,
...
dog1.name = "Max"
print(dog1.name)     # (Updated instance variable for dog1 object)
print(dog2.name)     # Does not update instance variable for dog2 object
# Modify class variable
Dog.species = "Feline"
print(dog1.species)  # (Updated class variable)
print(dog2.species)  # Common class attribute value for each instance or object after updating as well
